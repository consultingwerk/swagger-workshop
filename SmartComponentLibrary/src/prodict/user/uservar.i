...
{Consultingwerk/Studio/user-env.i {1}}
...
DEFINE BUTTON btn_Ok     LABEL "OK":U     {&STDPH_OKBTN} AUTO-GO.
DEFINE BUTTON btn_Cancel LABEL "Cancel":U {&STDPH_OKBTN} AUTO-ENDKEY.
...
&IF DEFINED (OpenEdge_12_4) NE 0 &THEN
...
&ENDIF
DEFINE {1} SHARED VARIABLE cachesize           AS CHARACTER  NO-UNDO  INITIAL  "0":U .
...
&IF "{&WINDOW-SYSTEM}" <> "TTY" &THEN
   ...
   DEFINE BUTTON    btn_Help LABEL "&Help":U {&STDPH_OKBTN}.
