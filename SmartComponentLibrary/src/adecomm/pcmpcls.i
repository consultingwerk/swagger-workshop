...
---------------------------------------------------------------------------*/
    ...
    DEFINE OUTPUT PARAMETER CompileFilename AS CHARACTER INITIAL ? NO-UNDO.
    ...
    FILE-INFORMATION:FILE-NAME = ClassTmpDir.
...
---------------------------------------------------------------------------*/
    ...
    DEFINE OUTPUT       PARAMETER lOK AS LOGICAL INITIAL FALSE NO-UNDO.
...
---------------------------------------------------------------------------*/
    ...
    DEFINE OUTPUT PARAMETER lOK AS LOGICAL INITIAL TRUE NO-UNDO.
    ...
    DEFINE VARIABLE cMsg AS CHARACTER INITIAL ? NO-UNDO.
    ...
    ASSIGN 
        ...
        cFilePath = FILE-INFORMATION:FULL-PATHNAME.
    ...
    DO:
        ASSIGN
          FILE-INFORMATION:FILE-NAME = cRPath
            cRPath = FILE-INFORMATION:FULL-PATHNAME.
    ...
    DO:
        ...
        IF cSrchFile <> ? THEN
            ASSIGN 
                FILE-INFORMATION:FILE-NAME = cSrchFile
                cSrchFile = FILE-INFORMATION:FULL-PATHNAME.
...
/*--------------------------------------------------------------------------
    ...
    Notes: 
---------------------------------------------------------------------------*/
  DEFINE VARIABLE lRet AS LOGICAL INITIAL NO    NO-UNDO.
  DEFINE VARIABLE cClassPath AS CHARACTER   NO-UNDO.
  DEFINE VARIABLE cBaseName AS CHARACTER   NO-UNDO.
  DEFINE VARIABLE cFilePath AS CHARACTER   NO-UNDO.
  DEFINE VARIABLE ipos AS INTEGER     NO-UNDO.
