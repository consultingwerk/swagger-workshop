...
*/
DEFINE VARIABLE Edit_Error_Title     AS CHAR INITIAL "Error"   NO-UNDO.
DEFINE VARIABLE Edit_Selection_Start AS INTEGER INITIAL ? NO-UNDO.
DEFINE VARIABLE Edit_Selection_End   AS INTEGER INITIAL ? NO-UNDO.
