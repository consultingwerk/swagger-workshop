...
---------------------------------------------------------------------------*/
    ...
    DEFINE VAR Confirm_Replace  AS LOGICAL NO-UNDO INITIAL YES.
...
----------------------------------------------------------------------------*/
    ...
    DEFINE OUTPUT PARAMETER p_Return_Value AS LOGICAL INITIAL ?.

    DEFINE VAR v_Response       AS CHARACTER FORMAT "!" NO-UNDO.
    DEFINE VAR Appl_Alert_Boxes AS LOGICAL INITIAL ?       NO-UNDO.
