...
*/
DEFINE VARIABLE Search_Info_Title  AS CHAR INITIAL "Information" NO-UNDO.
DEFINE VARIABLE Search_Quest_Title AS CHAR INITIAL "Question?"   NO-UNDO.
...
DEFINE VAR Find_Direction AS CHAR LABEL "Direction" INITIAL "DOWN"
